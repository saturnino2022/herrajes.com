        ...
        <div class="row">
          ...
          <div class="col-md-12-center mt-4">
            <div class="card">
              <div class="row">
                 <div class="col-md-12 ">
                  <img src="imagenes/visionimg.png" width="400" height="400"  class="img-fluid" >
                  </div>
                    <div class="col-md-12" >
                      <div class="card-body bg-secondary  bg-opacity-10">
                        <p>
                          Ser una macro empresa líder a nivel nacional, sobrepasando las perspectivas de nuestros clientes con productos de alta calidad y el continuo crecimiento de nuestra macro empresa.
                        </p>
                      </div> 
